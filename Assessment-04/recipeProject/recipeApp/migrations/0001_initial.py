    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('UserType', models.CharField(choices=[('Chef', 'Chef'), ('Viewers', 'Viewers')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Tags', models.CharField(choices=[('Vegetrian', 'Vegetrian'), ('Non-Vegetrian', 'Non-Vegetrian')], max_length=100, null=True)),
                ('RecipeCategory', models.CharField(choices=[('Breakfast', 'Breakfast'), ('Lunch', 'Lunch'), ('Dinner', 'Dinner')], max_length=100, null=True)),
                ('DifficultyLevel', models.CharField(choices=[('High', 'High'), ('Medium', 'Medium'), ('Low', 'Low')], max_length=100, null=True)),
                ('SampleImage', models.ImageField(null=True, upload_to='static/img/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Profile_Pic', models.ImageField(null=True, upload_to='static/Profile_Pic/')),
