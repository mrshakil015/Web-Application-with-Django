    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('UserType', models.CharField(choices=[('Recuriter', 'Recuriter'), ('Seeker', 'Seeker')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('myUser', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='recuriterprofile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
